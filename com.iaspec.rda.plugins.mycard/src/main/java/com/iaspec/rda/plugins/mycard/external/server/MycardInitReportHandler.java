...
public class MycardInitReportHandler  extends SimpleChannelUpstreamHandler implements IProtocol
{
	  private static final Logger logger =LoggerFactory.getLogger(MycardInitReportHandler.class);
	  private String sessionId;
	    
	  public MycardInitReportHandler(String sessionId)
	  {
	...
	{
		logger.info("Receive initReport(6,2,5) from client ");
	...
	{
		logger.info("Send the 'init Report confirm'(6,2,6) response to client.");
		PlatformResponse response =new PlatformResponse();
		byte[] bt = new byte[]{(byte) 0xFA,0x06,0x11,0x12,0x00,0x11,0x12,0x07,
				(byte) 0xCD,0x00,0x00,0x1F,(byte) 0xFF,(byte) 0xFF,(byte) 0xFB};
		...
		byte[] messageContent =new byte[]{0x02,0x00,0x00,0x0A,(byte) 0xFA,0x10,0x00,0x06,0x00,0x00,0x00,(byte) 0xFF,(byte) 0xFF,(byte) 0xFB};

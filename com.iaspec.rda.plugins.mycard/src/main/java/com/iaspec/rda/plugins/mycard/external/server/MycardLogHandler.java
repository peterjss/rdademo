...
public class MycardLogHandler extends SimpleChannelUpstreamHandler implements IProtocol
{
	  private static final Logger logger =LoggerFactory.getLogger(MycardLogHandler.class);
      private String serverId;
      private IMessageDispatcher messageDispatcher;
	  private String sessionId;
	  private GPSRequest gps;
	    
	  public MycardLogHandler(IchHandlerConfig config,GPSRequest gpsRequest,String sessionId)
	  {
	  ...
	  {
			logger.info("Receive Receive initReport(1,2,53) from client ");
		...
		{
			logger.info("Send the 'init Report confirm'(2,2) response to client.");

/*
 * @(#)MycardReAssignAddrHandler.java
 *
...
public class MycardReAssignAddrHandler  extends SimpleChannelUpstreamHandler implements IProtocol
{
	private static final Logger logger=LoggerFactory.getLogger(MycardReAssignAddrHandler.class);
	
	@Override
	public void messageReceived(final ChannelHandlerContext ctx, MessageEvent e) throws Exception
	{
		logger.info("Receive reqAssignAddr(3,3) from client ");
	...
	{
		logger.info("Send the 'reqAssignAddr_RES'(3,4) response to client.");
		...
		byte[] messageContent =new byte[]{0x04,0x00,0x11,0x12,0x07,(byte) 0xCD};

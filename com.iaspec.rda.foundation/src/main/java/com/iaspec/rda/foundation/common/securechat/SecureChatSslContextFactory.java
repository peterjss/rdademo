...
package com.iaspec.rda.foundation.common.securechat;
...
/**
 * Creates a bogus {@link javax.net.ssl.SSLContext}. A client-side context
 * created by this factory accepts any certificate even if it is invalid. A
 * server-side context created by this factory sends a bogus certificate defined
 * in {@link SecureChatKeyStore}.
 * <p/>
 ...
 * specify the {@link javax.net.ssl.KeyManager} that contains the client
 * certificate as the first argument of
 ...
 * specify the proper {@link javax.net.ssl.TrustManager} as the second argument
 * of
 * {@link javax.net.ssl.SSLContext#init(javax.net.ssl.KeyManager[], javax.net.ssl.TrustManager[], java.security.SecureRandom)}
